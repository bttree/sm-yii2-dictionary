...
<div class="dictionary-item-form">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <?= $form->field($model, 'dictionary_id')->dropDownList(Dictionary::getAllArrayForSelect()) ?>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <?= $form->field($model, 'slug')->widget(SlugWidget::className(),
                                                     [
                                                         'sourceFieldSelector' => '#dictionaryitem-name',
                                                         'url'                 => [
                                                             '/smydictionary/dictionary-item/get-model-slug'
                                                         ],
